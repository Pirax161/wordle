...
import os
from wordle_package.display import game_instructions, game_start_display, display_word_feedback, display_win, display_lost
...
from wordle_package.wordle import check_guess_correct, feed_back_word, MAX_ATTEMPTS


def main():
    # Read all the words from the file
    words_file_path = os.path.join('wordle_package','assets', 'word.txt')
